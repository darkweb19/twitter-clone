...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, email: string, profileImageUrl?: string | null, firstname: string, lastname: string } | null };
